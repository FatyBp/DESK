<?php
    ...
    class Reportes extends Conexion {
        ...
        $conexion = Conexion :: conectar();
        $sql = "DELETE FROM t_reportes WHERE idt_reporte = ?";
        $query = $conexion->prepare($sql);
        ...
        public function obtenerSolucion($idReporte){
            $conexion = Conexion :: conectar();
            $sql = "SELECT solucion_problema,estatus FROM t_reportes WHERE idt_reporte = '$idReporte' ";
        ...
        public function actualizarSoluucion($datos){
            $conexion = Conexion :: conectar();
